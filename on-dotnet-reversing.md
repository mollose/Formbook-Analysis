...
- [.NET 정보를 얻는 방법](#net-정보를-얻는-방법)
- [CLR(공용 언어 런타임)](#clr공용-언어-런타임)
...
- [Main() Method Directives](#main-method-directives)
  * [.locals](#locals)
- [CIL 데이터 타입](#cil-데이터-타입)
- [MSIL 코드 레이블](#msil-코드-레이블)
- [MSIL Opcodes](#msil-opcodes)
  ...
  * [Boxing](#boxing)
- [인터페이스](#인터페이스)
- [MSIL 코드 생성](#msil-코드-생성)
- [메타데이터 및 자동 기술 구성 요소](#메타데이터-및-자동-기술-구성-요소)
- [Opcodes.Ldtoken 필드](#opcodesldtoken-필드)
- [Type.GetTypeFromHandle(RuntimeTypeHandle)](#typegettypefromhandleruntimetypehandle)
- [ResourceManager(Type)](#resourcemanagertype)
- [.resources 파일의 리소스](#resources-파일의-리소스)
- [.resources 파일에서 리소스 검색](#resources-파일에서-리소스-검색)
- [애플리케이션 도메인 및 어셈블리](#애플리케이션-도메인-및-어셈블리)
- [애플리케이션 도메인과 스레드](#애플리케이션-도메인과-스레드)
- [AppDomain.CurrentDomain 속성](#appdomaincurrentdomain-속성)
- [AppDomain.Load(Byte[])](#appdomainloadbyte)
- [Assembly.GetTypes 메서드](#assemblygettypes-메서드)
- [Type.GetMethods 메서드](#typegetmethods-메서드)
- [파일 기반 리소스 로딩](#파일-기반-리소스-로딩)
</br>
...
#### <ins>(2) NGen.exe를 사용하여 설치 시간 코드 생성</ins>
